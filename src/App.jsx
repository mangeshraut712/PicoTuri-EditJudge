    ...
    <div className="space-y-6">
      ...
      <div className="glass rounded-2xl p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="p-6 bg-white/5 rounded-lg">
            ...
            <p className="text-gray-300 mb-4">
              Large-scale dataset for instruction-based image editing with 400K+ samples
            </p>
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between p-2 bg-black/20 rounded">
                <span className="text-xs text-gray-400">Repository</span>
                <a 
                  href="https://github.com/apple/pico-banana-400k" 
                  target="_blank" 
              ...
              <div className="flex items-center justify-between p-2 bg-black/20 rounded">
                ...
                <span className="text-xs font-semibold text-green-400">Image Editing</span>
              </div>
            </div>
            <p className="text-xs text-gray-400">
              Foundation dataset for training instruction-following image editing models
            </p>
          </div>
          ...
          <div className="p-6 bg-white/5 rounded-lg">
            ...
            <p className="text-gray-300 mb-4">
              Machine learning framework for creating custom models with ease
            </p>
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between p-2 bg-black/20 rounded">
                <span className="text-xs text-gray-400">Repository</span>
                <a 
                  href="https://github.com/apple/turicreate" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-xs text-blue-400 hover:text-blue-300 underline"
                >
              ...
              <div className="flex items-center justify-between p-2 bg-black/20 rounded">
                ...
                <span className="text-xs font-semibold text-purple-400">ML Framework</span>
              </div>
            </div>
            <p className="text-xs text-gray-400">
              Core ML integration and model deployment capabilities
            </p>
          </div>
        </div>
        ...
        <div className="p-6 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-lg border border-indigo-500/20">
          ...
          <p className="text-gray-300 mb-4">
            Advanced methodologies for instruction-based image editing and model optimization
          </p>
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="p-4 bg-black/20 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <a 
                  href="https://www.arxiv.org/pdf/2510.19808" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-xs text-blue-400 hover:text-blue-300 underline"
                >
              ...
              <p className="text-xs text-gray-300">
                Comprehensive research on image editing algorithms and optimization techniques
              </p>
            </div>
            <div className="p-4 bg-black/20 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs text-gray-400">Key Contributions</span>
                <span className="text-xs font-semibold text-green-400">7 Areas</span>
              </div>
              <ul className="text-xs text-gray-300 space-y-1">
                <li>• Quality assessment metrics</li>
                <li>• Diffusion model architectures</li>
                <li>• Direct preference optimization</li>
                <li>• Multi-turn editing systems</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="glass rounded-2xl p-6">
        <h2 className="text-2xl font-bold mb-6">Algorithm Implementation Details</h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-grow">
                  ...
                  <div className="p-3 bg-black/20 rounded-lg mb-3">
                    <div className="text-xs text-gray-400 mb-2">Research Foundation</div>
